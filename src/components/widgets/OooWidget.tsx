...
function TimeComboBox({
  ...
  return (
    <div ref={wrapperRef} className="relative">
      <div className="flex items-center border border-gray-200 dark:border-gray-700 rounded-lg h-9 bg-white dark:bg-gray-900 overflow-hidden focus-within:border-brand-blue focus-within:ring-2 focus-within:ring-brand-blue/20 transition-shadow">
        ...
        <button
          ...
          className="px-2 h-full hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border-l border-gray-100 dark:border-gray-700"
        >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute z-50 top-full left-0 right-0 mt-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg max-h-48 overflow-y-auto"
          >
            {filtered.map((t) => (
              <button
                key={t}
            ...
            {filtered.length === 0 && (
              <div className="px-3 py-2 text-xs text-gray-400 dark:text-gray-500 italic">No matching time</div>
            )}
          </motion.div>
        )}
      </AnimatePresence>
            ...
            <div className="space-y-4 border-t border-gray-100 dark:border-gray-700 pt-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-8 text-xs h-9 rounded-lg border-gray-200 dark:border-gray-700"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full text-xs px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/20 outline-none resize-none bg-white dark:bg-gray-900 dark:text-gray-200 transition-shadow"
                ...
                >
                  <div
                    className={`relative w-9 h-5 rounded-full transition-colors duration-200 ${
                      enableForwarding ? "bg-brand-blue" : "bg-gray-300 dark:bg-gray-600"
                    }`}
                  >
                    <motion.div
              ...
              <div className="flex gap-2 pt-1">
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  className="text-xs h-9 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
