...
export function FeedPanel() {
  ...
  return (
    <div className="flex flex-col min-h-0 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
      {/* Tabs */}
      ...
      {/* Content */}
        <div className="bg-brand-bg/50 dark:bg-gray-800/50 flex-1 overflow-y-auto scrollbar-thin">
