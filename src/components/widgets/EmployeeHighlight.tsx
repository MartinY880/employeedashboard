...
export function EmployeeHighlight() {
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden h-full flex flex-col">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            >
              ...
              <img
                ...
                className="w-14 h-14 rounded-full object-cover border-[3px] border-amber-200 hover:opacity-80 transition-opacity shadow-sm"
              />
            </button>
            ...
            <div className="min-w-0">
              <button
                type="button"
                onClick={() => handlePersonClick(highlight.employeeId)}
                className="text-[13px] font-bold text-gray-900 dark:text-gray-100 leading-tight hover:text-brand-blue transition-colors cursor-pointer focus:outline-none"
              >
