...
if (isLoading) {
    return (
      <div className="flex-1 p-2.5 animate-pulse">
  <div className="grid grid-cols-2 gap-1.5">
    <div className="h-[38px] rounded-xl bg-gray-100 dark:bg-gray-800" />
    <div className="h-[38px] rounded-xl bg-gray-100 dark:bg-gray-800" />
    <div className="h-[38px] rounded-xl bg-gray-100 dark:bg-gray-800" />
    <div className="h-[38px] rounded-xl bg-gray-100 dark:bg-gray-800" />
    <div className="h-[38px] rounded-xl bg-gray-100 dark:bg-gray-800" />
...
<div className="flex-1 p-2.5">
    ...
    <div className="h-full grid grid-cols-2 gap-1 content-start">
      {links.map((link, i) => (
        <motion.a
          ...
          className="flex items-center gap-2 px-2 py-1 rounded-lg text-[11px] font-semibold text-gray-700 dark:text-gray-200 border border-gray-200/80 dark:border-gray-700/80 bg-gray-50/70 dark:bg-gray-800/60 hover:bg-brand-blue/5 hover:text-brand-blue hover:border-brand-blue/25 transition-all"
        >
  ...
  {renderQuickLinkIconPreview(link.icon, "w-2.5 h-2.5")}
</span>
