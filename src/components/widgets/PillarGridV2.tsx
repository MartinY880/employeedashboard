      ...
      <div className="min-w-[600px]">
        ...
        {data.rows.map((row, rowIdx) => (
          <div key={row.id} className="grid grid-cols-3 gap-3 mb-3">
            {/* Column 1: Icon + Title (blue, icon above title) */}
            <motion.div
              ...
              className="relative bg-gradient-to-br from-brand-blue to-[#084f96] text-white px-4 py-4 rounded-xl shadow-lg flex flex-col items-center justify-center gap-1.5 cursor-default overflow-hidden group"
            >
            ...
            {/* Column 2: Text (alternating row colors) */}
            <motion.div
              initial={{ opacity: 0, y: 16, scale: 0.97 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              ...
              onHoverStart={playPop}
              className="relative px-4 py-4 rounded-xl shadow-lg flex items-center cursor-default overflow-hidden group bg-white"
            >
              <span
                className="font-medium leading-relaxed relative z-10 whitespace-pre-line text-[#333333]"
            ...
            {/* Column 3: Text (alternating row colors) */}
            <motion.div
              initial={{ opacity: 0, y: 16, scale: 0.97 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
